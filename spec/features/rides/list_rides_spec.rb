...
RSpec.feature "List rides" do
  before do
    ...
    @ride2 = @mladen.rides.create(origin_city: "Novi Sad", destination_city: "Berlin", ride_date: "07-06-2017", ride_time: "13:00:00", price: "900", seats: "3", details: "Pick you up near Strand")
  end
  ...
  scenario do
    ...
    expect(page).to have_content(@ride2.details[0..51])
  end
end